...
namespace Metro2018.Web.Controllers
{
    public class TareasController : Controller
    {
        ...
        {
            iP = new TareasProcessor(new TareasRepository());
        }
        ...
        [HttpPost]
        public ActionResult Create(Tarea tareas)
        {
            iP.Create(tareas);
        ...
        {
            Tarea tareas = iP.ReadById(id).GetAwaiter().GetResult();
            return View(tareas);
        }
        ...
        {
            Tarea i = iP.ReadById(id).GetAwaiter().GetResult();
            return View(i);
        }

        [HttpPost]
        public ActionResult Edit(Tarea editado)
        {
